...
const addproductstockController = require("@controller/addProductStockController");
...
router.post("/addstock", verifyTokenAdmin, addproductstockController.post);
router.get("/product", verifyTokenAdmin, getproductController.get);
router.get("/group", verifyTokenAdmin, getproductgroupController.get);
...
router.put("/code", verifyTokenAdmin, updatepromotionalcodeController.put);
...
router.put("/updatestock", verifyTokenAdmin, updatestockController.put);
