...
CREATE TABLE public.bills_pay (
    ...
    creation_user character varying(50) DEFAULT 'Diego'::character varying NOT NULL,
    update_timestamp timestamp with time zone DEFAULT timezone('America/Sao_Paulo'::text, now()) NOT NULL,
...
CREATE TABLE public.bills_receive (
    ...
    deadline date NOT NULL,
    creation_timestamp timestamp with time zone DEFAULT timezone('America/Sao_Paulo'::text, now()) NOT NULL,
    creation_user character varying(50) DEFAULT 'Node'::character varying NOT NULL,
    update_timestamp timestamp with time zone DEFAULT timezone('America/Sao_Paulo'::text, now()) NOT NULL,
    update_user character varying(50),
    deleted_at date,
...
CREATE TABLE public.sale_items (
    ...
    delivery_method character varying(70) NOT NULL,
...
CREATE TABLE public.stock (
    ...
    creation_timestamp timestamp with time zone DEFAULT timezone('America/Sao_Paulo'::text, now()) NOT NULL,
    creation_user character varying(50) DEFAULT 'Diego'::character varying,
    update_timestamp timestamp with time zone DEFAULT timezone('America/Sao_Paulo'::text, now()) NOT NULL,
    update_user character varying(50) DEFAULT 'Diego'::character varying,
    deleted_at date
);
...
CREATE TABLE public.users (
    ...
    creation_user character varying(50) DEFAULT 'Diego'::character varying NOT NULL,
    update_timestamp timestamp with time zone DEFAULT timezone('America/Sao_Paulo'::text, now()) NOT NULL,
    update_user character varying(50) DEFAULT 'Diego'::character varying NOT NULL,
    deleted_at date,
...
COPY public.bills_pay (id, provider_id, amount, currency, method_id, deadline, creation_timestamp, creation_user, update_timestamp, update_user, deleted_at, user_id) FROM stdin;
1	1	150	BRL	8	2021-08-14	2021-08-03 15:53:32.070353+00	Diego	2021-08-03 15:53:32.070353+00	Diego	\N	\N
7	\N	140.47	BRL	8	2021-09-14	2021-08-15 20:50:34.924476+00	Diego	2021-08-15 20:50:34.924476+00	\N	\N	1
8	\N	280.94	BRL	8	2021-09-15	2021-08-16 15:54:32.475897+00	Diego	2021-08-16 15:54:32.475897+00	\N	\N	1
10	\N	261.85	BRL	8	2021-09-15	2021-08-16 23:53:23.815314+00	Diego	2021-08-16 23:53:23.815314+00	\N	\N	1
11	\N	140.47	BRL	8	2021-09-16	2021-08-17 01:46:54.832761+00	Diego	2021-08-17 01:46:54.832761+00	\N	\N	1
\.
...
COPY public.bills_receive (id, user_id, sale_header_id, amount, currency, method_id, deadline, creation_timestamp, creation_user, update_timestamp, update_user, deleted_at, refunded) FROM stdin;
2	2	1	200.00	BRL	8	2021-08-30	2021-08-03 15:53:48.807866+00	Diego	2021-08-03 15:53:48.807866+00	Diego	\N	f
3	1	27	150.47	BRL	8	2021-08-16	2021-08-15 19:52:34.441673+00	Diego	2021-08-15 19:52:34.441673+00	\N	\N	f
4	1	28	140.47	BRL	8	2021-08-16	2021-08-15 20:32:42.680754+00	Node	2021-08-15 20:32:42.680754+00	\N	2021-08-15	t
5	1	29	280.94	BRL	8	2021-08-17	2021-08-16 15:50:19.794696+00	Node	2021-08-16 15:50:19.794696+00	\N	2021-08-16	t
7	1	31	290.94	BRL	8	2021-08-17	2021-08-16 23:22:15.176733+00	Node	2021-08-16 23:22:15.176733+00	\N	\N	f
8	1	32	261.846	BRL	8	2021-08-17	2021-08-16 23:22:54.39149+00	Node	2021-08-16 23:22:54.39149+00	\N	2021-08-16	t
9	1	33	140.47	BRL	8	2021-08-18	2021-08-17 01:44:47.33526+00	Node	2021-08-17 01:44:47.33526+00	\N	2021-08-17	t
6	1	30	431.40	BRL	8	2021-08-17	2021-08-16 23:20:25.835941+00	Node	2021-08-16 23:20:25.835941+00	\N	\N	f
10	1	34	150.47	BRL	8	2021-08-18	2021-08-17 23:30:04.181974+00	Node	2021-08-17 23:30:04.181974+00	\N	\N	f
\.
...
COPY public.products (id, group_id, name, price, description, add_date, creation_user, update_timestamp, update_user, deleted_at, image) FROM stdin;
1	1	Acer Inspire	140.47	Notebook muito loko	2021-08-03	Diego	2021-08-03 15:52:43.11834+00	Diego	\N	\N
13	6	test4	150.47	test_description4	2021-08-11	Diego	2021-08-11 19:11:40.310654+00	\N	\N	\N
14	6	test45controller	120.47	test5_descriptioncontroller	2021-08-16	Diego	2021-08-16 19:32:22.19335+00	\N	\N	\N
16	6	test46controllerfinal	121.47	test6_descriptioncontroller	2021-08-17	Diego	2021-08-17 01:26:44.609603+00	\N	\N	\N
\.
...
COPY public.products_group (id, name, creation_timestamp, creation_user, update_timestamp, update_user, deleted_at) FROM stdin;
1	Notebooks	2021-08-03 15:52:38.006153+00	Diego	2021-08-03 15:52:38.006153+00	Diego	\N
6	Notebooks5	2021-08-11 19:11:28.701009+00	Diego	2021-08-11 19:11:28.701009+00	\N	2021-08-11
7	Notebookscontroller	2021-08-16 19:37:27.729939+00	Diego	2021-08-16 19:37:27.729939+00	\N	\N
9	Notebooksfinalsu	2021-08-17 01:26:58.651949+00	Diego	2021-08-17 01:26:58.651949+00	\N	\N
\.
...
COPY public.promotional_codes (id, code, discount, type_discount, deleted_at) FROM stdin;
1	QWOEPAKMQJF47891	10.00	percentage	\N
6	SHASHASHA2	120.00	fix	2021-08-11
7	XWOEPAKMQJF47891	90.00	percentage	\N
9	VWOEPAKMQJF47892	32.00	percentage	\N
\.
...
COPY public.providers (id, document, name, country, state, product_type, phone, zip_code, creation_timestamp, creation_user, update_timestamp, update_user, deleted_at) FROM stdin;
1	00000178-8	Seu José Eletrônicos	Brazil	SC	Notebooks	47123456789	00001-001	2021-08-03 15:52:14.354947+00	Diego	2021-08-03 15:52:14.354947+00	Diego	\N
4	20000178-8	Pedrinho eletronicos 2.0	Brazil	SP	Notebooks	12345678	0123456-7	2021-08-11 19:27:16.90344+00	Diego	2021-08-11 19:27:16.90344+00	\N	\N
6	20000179-8	Pedrinho eletronicos 3.0controllerses	Brazil	SP	Notebooks	12445678	0223456-7	2021-08-16 19:39:41.119639+00	Diego	2021-08-16 19:39:41.119639+00	\N	\N
7	10000129-8	Pedrinho 5.0	Brazil	SP	Notebooks	13445678	0223456-7	2021-08-17 01:27:20.173283+00	Diego	2021-08-17 01:27:20.173283+00	\N	\N
\.
...
6	1	negocio ruim blabla controller	33	2021-08-17
\.
...
COPY public.sale_header (id, user_id, promotional_code_id, total, payment_method_id, creation_timestamp, creation_user, update_timestamp, update_user, deadline, deleted_at, refunded) FROM stdin;
1	2	\N	150.47	8	2021-08-03 15:52:34.339024+00	Diego	2021-08-03 15:52:34.339024+00	Diego	2021-08-12	\N	f
2	1	\N	140.47	8	2021-08-08 17:45:51.576667+00	Diego	2021-08-08 17:45:51.576667+00	Diego	2021-08-12	\N	f
21	1	1	388.27	8	2021-08-14 18:29:53.195952+00	1	2021-08-14 18:29:53.195952+00	1	2021-08-15	\N	f
25	1	\N	421.41	8	2021-08-15 18:19:15.85087+00	1	2021-08-15 18:19:15.85087+00	1	2021-08-16	\N	f
26	1	\N	150.47	8	2021-08-15 19:51:27.510948+00	1	2021-08-15 19:51:27.510948+00	1	2021-08-16	\N	f
27	1	\N	150.47	8	2021-08-15 19:52:34.436141+00	1	2021-08-15 19:52:34.436141+00	1	2021-08-16	\N	f
28	1	\N	140.47	8	2021-08-15 20:32:42.675829+00	1	2021-08-15 20:32:42.675829+00	1	2021-08-16	\N	t
29	1	\N	280.94	8	2021-08-16 15:50:19.252597+00	1	2021-08-16 15:50:19.252597+00	1	2021-08-17	\N	t
30	1	\N	431.41	8	2021-08-16 23:20:25.801414+00	1	2021-08-16 23:20:25.801414+00	1	2021-08-17	\N	f
31	1	\N	290.94	8	2021-08-16 23:22:15.168203+00	1	2021-08-16 23:22:15.168203+00	1	2021-08-17	\N	f
32	1	1	261.85	8	2021-08-16 23:22:54.383509+00	1	2021-08-16 23:22:54.383509+00	1	2021-08-17	\N	t
33	1	\N	140.47	8	2021-08-17 01:44:47.324297+00	1	2021-08-17 01:44:47.324297+00	1	2021-08-18	\N	t
34	1	\N	150.47	8	2021-08-17 23:30:04.168587+00	1	2021-08-17 23:30:04.168587+00	1	2021-08-18	\N	f
\.
...
COPY public.sale_items (sale_header_id, line, product_id, delivery_method, delivery_price, sold_amount, unitary_value, discount_value, plus_value, total, deleted_at, refunded) FROM stdin;
1	1	1	Courier	10.00	1	140.47	0.00	0.00	150.47	\N	f
2	1	1	Courier	10.47	1	140.47	0.00	0.00	140.47	\N	f
21	2	1	Courier	0.00	2	126.42	10.00	0.00	252.85	\N	f
21	1	13	Courier	0.00	1	135.42	10.00	0.00	135.42	\N	f
25	3	1	Courier	0.00	3	140.47	0.00	0.00	421.41	\N	f
26	1	13	Courier	0.00	1	150.47	0.00	0.00	150.47	\N	f
27	1	13	Courier	0.00	1	150.47	0.00	0.00	150.47	\N	f
28	1	1	Courier	0.00	1	140.47	0.00	0.00	140.47	\N	t
29	2	1	Courier	0.00	2	140.47	0.00	0.00	280.94	\N	t
30	2	1	Courier	0.00	2	140.47	0.00	0.00	280.94	\N	f
30	1	13	Courier	0.00	1	150.47	0.00	0.00	150.47	\N	f
31	1	13	Courier	0.00	1	150.47	0.00	0.00	150.47	\N	f
31	1	1	Courier	0.00	1	140.47	0.00	0.00	140.47	\N	f
32	1	1	Courier	0.00	1	126.42	10.00	0.00	126.42	\N	t
32	1	13	Courier	0.00	1	135.42	10.00	0.00	135.42	\N	t
33	1	1	Courier	0.00	1	140.47	0.00	0.00	140.47	\N	t
34	1	13	Courier	0.00	1	150.47	0.00	0.00	150.47	\N	f
\.
...
COPY public.stock (product_id, amount, creation_timestamp, creation_user, update_timestamp, update_user, deleted_at) FROM stdin;
1	3	2021-08-03 15:53:51.909662+00	Diego	2021-08-03 15:53:51.909662+00	Diego	\N
13	7	2021-08-12 19:26:36.78147+00	Diego	2021-08-12 19:26:36.78147+00	Diego	\N
\.
...
COPY public.users (id, role_id, document, email, password, first_name, last_name, address, city, state, zip_code, phone, birth_date, creation_timestamp, creation_user, update_timestamp, update_user, deleted_at, reset_code, expire_time) FROM stdin;
23	2	573478513	pedro-s23.novaes@hotmail.com	$2b$10$8hh7vv7kEOPYEopVIPQFc.kmPdtxhPumS.7kqK/1hJCWzAMmtK/Pu	Pedrao3	Sousa2	test72	Guarulhos	SP	133	1177016064	2001-09-27	2021-08-11 19:46:11.782802+00	Diego	2021-08-11 19:46:11.782802+00	Diego	2021-08-11	\N	\N
2	1	575107449	pedrinho@hotmail.com	123	Pedrinho	Pedrao	test2	Guarulhos	SP	08943-210	11978151606	1995-04-22	2021-08-03 15:52:11.317722+00	Diego	2021-08-03 15:52:11.317722+00	Diego	\N	\N	\N
21	2	543478513	diego-s23.novaes@hotmail.com	12345	Diegao2	Sousa2	test2	Guarulhos	SP	123	1197016064	2001-09-27	2021-08-10 15:57:36.532548+00	Diego	2021-08-10 15:57:36.532548+00	Diego	\N	\N	\N
28	2	473478519	pedro-ss.novaes@hotmail.com	$2b$10$wCwOzWrRQMjcqkvUupJuT.9hzmVXtdSd4BVoiLAM7lTF9zo4g11nq	Pedrao3	Sousa2	test72	Guarulhos	SP	133	1187016064	2001-09-27	2021-08-16 19:07:37.059424+00	Diego	2021-08-16 19:07:37.059424+00	Diego	2021-08-16	\N	\N
7	1	545307477	diego-s2.novaes@hotmail.com	1234	Diego	Sousa	test	Guarulhos	SP	07243-210	119701516067	2001-09-27	2021-08-10 15:40:33.564356+00	Diego	2021-08-10 15:40:33.564356+00	Diego	\N	b04ce34b77a6eaf3e97f903468e68980bdf11dbd	2021-08-17 03:25:31.247
1	1	545307478	diego-s.novaes@hotmail.com	$2b$10$PNyCfXwtEmhtunORXV.i/e0Mvq/FJnpYd5Z1QJgHnk.0clVC2sgBS	Diego	Sousa	test	Guarulhos	SP	07243-210	11970151606	2001-09-27	2021-08-03 15:52:08.370274+00	Diego	2021-08-03 15:52:08.370274+00	Diego	\N	26d34d70e51d14d08058ed115c2f3719608b3a7b	2021-08-17 03:25:50.513
30	2	973478519	pedroc-controler.novaes@hotmail.com	$2b$10$lZu064/TMX0DTl77spPwl.Xb9TDj3s2fQa8vuvza.kA3hlaWjO2Z2	Pedrao3	Sousa2	test72	Guarulhos	SP	133	1787016064	2001-09-27	2021-08-17 01:24:11.936339+00	Diego	2021-08-17 01:24:11.936339+00	Diego	2021-08-17	\N	\N
\.
...
SELECT pg_catalog.setval('public.bills_pay_id_seq', 11, true);
...
SELECT pg_catalog.setval('public.bills_receive_id_seq', 10, true);
...
SELECT pg_catalog.setval('public.payment_method_id_seq', 16, true);
...
SELECT pg_catalog.setval('public.products_group_id_seq', 10, true);
...
SELECT pg_catalog.setval('public.promotional_codes_id_seq', 10, true);
...
SELECT pg_catalog.setval('public.req_refunds_id_seq', 6, true);
...
SELECT pg_catalog.setval('public.sale_header_id_seq', 34, true);
...
--
-- Name: sale_items_delivery; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX sale_items_delivery ON public.sale_items USING btree (delivery_method, deleted_at);
